<template>
  <div class="home">
    ...
    <BlogPost :post="posta" v-for="(posta, index) in blogPostsFeed" :key="index" />
    <div class="blog-card-wrap">
      <div class="container">
        <h3>View More Recent Blogs</h3>
        <div class="blog-cards">
          <BlogCard :post="card" v-for="(card, index) in blogPostsCards" :key="index" />
        </div>
      </div>
    </div>
      ...
      sampleBlogPost: [
        {
          ...
          blogHTML: "This is a filtter blog post title",
